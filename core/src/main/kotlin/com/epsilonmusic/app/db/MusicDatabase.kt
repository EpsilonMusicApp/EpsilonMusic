...
package com.epsilonmusic.app.db
...
import com.epsilonmusic.app.db.daos.SpeedDialDao
import com.epsilonmusic.app.db.entities.AlbumArtistMap
...
import com.epsilonmusic.app.db.entities.PlayCountEntity
import com.epsilonmusic.app.db.entities.PlaylistEntity
import com.epsilonmusic.app.db.entities.PlaylistSongMap
import com.epsilonmusic.app.db.entities.PlaylistSongMapPreview
import com.epsilonmusic.app.db.entities.RecognitionHistory
import com.epsilonmusic.app.db.entities.RelatedSongMap
import com.epsilonmusic.app.db.entities.SearchHistory
import com.epsilonmusic.app.db.entities.SetVideoIdEntity
import com.epsilonmusic.app.db.entities.SongAlbumMap
import com.epsilonmusic.app.db.entities.SongArtistMap
...
val MIGRATION_1_2 =
    object : Migration(1, 2) {
        override fun migrate(db: SupportSQLiteDatabase) {
            ...
            // Apply the renumbered (clean, sequential, per-playlist) positions — the old
            // code computed them but discarded the result, so playlists migrated from a
            // legacy backup kept non-sequential positions and drag-reorder (which assumes
            // contiguous positions) silently did nothing on them.
