...
import com.epsilonmusic.app.utils.PlaybackLogManager
import com.epsilonmusic.app.utils.PlaybackLogLevel
...
import com.epsilonmusic.app.utils.YTPlayerUtils.MAIN_CLIENT
import com.epsilonmusic.app.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.epsilonmusic.app.utils.YTPlayerUtils.validateStatus
import com.epsilonmusic.app.utils.potoken.PoTokenGenerator
import com.epsilonmusic.app.utils.potoken.PoTokenResult
import com.epsilonmusic.app.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: com.epsilonmusic.app.constants.PlaybackEngine = com.epsilonmusic.app.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == com.epsilonmusic.app.constants.PlaybackEngine.POTOKEN || engine == com.epsilonmusic.app.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == com.epsilonmusic.app.constants.PlaybackEngine.BRAVEPIPE || engine == com.epsilonmusic.app.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
